...
if [ "${cmd}" == "reset" ]; then
    ...
    cp -f /mnt/efs/bsc-qa/bc-fusion-staking-env/bsc_cluster/password.txt /server/bsc/validator/
    cp -r /mnt/efs/bsc-qa/bc-fusion-staking-env/bsc_cluster/clusterNetwork/node${i}/* /server/bsc/validator/
fi

rm -rf /server/bsc/validator/bls
rm -rf /server/bsc/validator/keystore
yes | cp -rf /mnt/efs/bsc-qa/bc-fusion-staking-env/bsc_cluster/geth /server/bsc/validator/geth${i}
yes | cp -rf /mnt/efs/bsc-qa/bc-fusion-staking-env/bsc_cluster/clusterNetwork/node${i}/config.toml /server/bsc/validator/
yes | cp -rf /mnt/efs/bsc-qa/bc-fusion-staking-env/bsc_cluster/clusterNetwork/node${i}/keystore /server/bsc/validator/
yes | cp -rf /mnt/efs/bsc-qa/bc-fusion-staking-env/bsc_cluster/clusterNetwork/node${i}/bls /server/bsc/validator/
