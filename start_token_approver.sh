...
yes | cp -rf /mnt/efs/bsc-qa/bc-fusion-staking-env//approval_service/approver /server/token_approver/approver
yes | cp -rf /mnt/efs/bsc-qa/bc-fusion-staking-env//dump_bc_account/output/accounts.json /server/token_approver/accounts.json
yes | cp -rf /mnt/efs/bsc-qa/bc-fusion-staking-env//dump_bc_account/output/proofs.json /server/token_approver/merkle_proofs.json
