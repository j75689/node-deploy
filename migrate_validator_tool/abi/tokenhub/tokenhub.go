...
// ClaimRewardsforFinality is a paid mutator transaction binding the contract method 0x0027253a.
//
// Solidity: function claimRewardsforFinality(address , uint256 ) returns(uint256)
func (_Tokenhub *TokenhubTransactor) ClaimRewardsforFinality(opts *bind.TransactOpts, arg0 common.Address, arg1 *big.Int) (*types.Transaction, error) {
	return _Tokenhub.contract.Transact(opts, "claimRewardsforFinality", arg0, arg1)
}

// ClaimRewardsforFinality is a paid mutator transaction binding the contract method 0x0027253a.
//
// Solidity: function claimRewardsforFinality(address , uint256 ) returns(uint256)
func (_Tokenhub *TokenhubSession) ClaimRewardsforFinality(arg0 common.Address, arg1 *big.Int) (*types.Transaction, error) {
	return _Tokenhub.Contract.ClaimRewardsforFinality(&_Tokenhub.TransactOpts, arg0, arg1)
}

// ClaimRewardsforFinality is a paid mutator transaction binding the contract method 0x0027253a.
//
// Solidity: function claimRewardsforFinality(address , uint256 ) returns(uint256)
func (_Tokenhub *TokenhubTransactorSession) ClaimRewardsforFinality(arg0 common.Address, arg1 *big.Int) (*types.Transaction, error) {
	return _Tokenhub.Contract.ClaimRewardsforFinality(&_Tokenhub.TransactOpts, arg0, arg1)
}
